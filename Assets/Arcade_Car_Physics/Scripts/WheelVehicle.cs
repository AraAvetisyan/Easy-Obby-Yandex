...
namespace VehicleBehaviour {
    ...
    public class WheelVehicle : MonoBehaviour {
        ...
        public void Go(bool down)
        {
            if (down)
            {
                StartCoroutine(BrakeForwardCorutine());
                handbrake = true;
            }
            else
            {
        ...
        public void Stop(bool down)
        {
            if (down)
            {
                StartCoroutine(BrakeReverseCorutine());
        ...
        public IEnumerator BrakeReverseCorutine()
        {
            yield return new WaitForSeconds(0.5f);
            handbrake = false;
            throttle = -1.5f;
        }
        public IEnumerator BrakeForwardCorutine()
        {
